...
namespace ChobiAssets.PTM
{
	...
	public class MainBody_Setting_CS : MonoBehaviour
	{
		...
		*/
        ...
        public bool Visible_Flag = true; // Referred to from "Static_Track_Parent_CS", "Static_Wheel_Parent_CS", "Track_Deform_CS", "Track_Scroll_CS", "Track_Joint_CS".
        ...
        IEnumerator Soft_Landing(Rigidbody tempRigidbody)
        {
            ...
            float defaultDrag = tempRigidbody.linearDamping;
            tempRigidbody.linearDamping = Landing_Drag;
            ...
            // Return them.
            tempRigidbody.linearDamping = defaultDrag;
