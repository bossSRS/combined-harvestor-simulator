    ...
    public class Track_Scroll_CS : MonoBehaviour
    {
		...
		*/
        ...
        void Update()
        {
            ...
            if (bodyScript == null || bodyScript.Visible_Flag)
            {
                Scroll();
            }
        }
        ...
        void Scroll()
        {
            if (Reference_Wheel == null) return;
            ...
            if (thisMaterial != null)
            {
                ...
                if (thisMaterial.HasProperty("_BaseColorMap"))
                {
                    thisMaterial.SetTextureOffset("_BaseColorMap", offset);
                }
                if (thisMaterial.HasProperty("_BaseMap"))
                {
                    thisMaterial.SetTextureOffset("_BaseMap", offset);
                }
                if (thisMaterial.HasProperty(General_Settings_CS.Main_Tex_Name))
                {
