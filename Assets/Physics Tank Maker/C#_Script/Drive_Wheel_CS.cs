    ...
    public class Drive_Wheel_CS : MonoBehaviour
    {
		...
		*/
        ...
        void Control_Rigidbody()
        {
            ...
            if (Is_Left)
            { // Left
                This_Rigidbody.angularDamping = Parent_Script.Left_Angular_Drag;
                This_Rigidbody.AddRelativeTorque(0.0f, Parent_Script.Left_Torque, 0.0f);
            }
            else
            { // Right
                This_Rigidbody.angularDamping = Parent_Script.Right_Angular_Drag;
        ...
        { // Called from "Damage_Control_Center_CS".
            ...
            // Lock the wheel.
            This_Rigidbody.angularDamping = Mathf.Infinity;
