...
namespace ChobiAssets.PTM
{
	...
	public class Create_SteeredWheel_CSEditor : Editor
	{
        ...
        void Set_Inspector ()
		{
			...
			GUI.backgroundColor = new Color (1.0f, 1.0f, 0.5f, 1.0f);
			Wheel_Collider_MaterialProp.objectReferenceValue = EditorGUILayout.ObjectField ("Physic Material", Wheel_Collider_MaterialProp.objectReferenceValue, typeof(PhysicsMaterial), false);
		...
		void Create_Wheel (string direction, Vector3 position)
		{
			...
			sphereCollider.material = Wheel_Collider_MaterialProp.objectReferenceValue as PhysicsMaterial;
			// HingeJoint
			HingeJoint hingeJoint;
